...
| 7   | **Availability expiry reminder** | 7-day windows auto-expire silently. No "your availability expires tomorrow" notification. Crew disappear from discover results without knowing. Need push/in-app notification 24h before expiry.                                                                                                           | [x]    | 102   |
...
| 10  | **Message polling lag**          | After acceptance, crew/employer coordinate logistics via chat. Polling interval makes this feel sluggish. This is the one place Supabase Realtime genuinely matters for UX. Not a blocker but noticeable.                                                                                                  | [x]    | 104   |
...
| #   | Gap                                          | Detail                                                                                                                                                                                                                            | Status | Stage |
| --- | -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ----- |
| 11  | **Deep links (Universal Links / App Links)** | Capacitor configured, push notifications resolve deep links client-side, but iOS Universal Links and Android App Links need domain verification files at `/.well-known/`. Without this, push taps may not open the app correctly. | [x]    | 105   |
| 12  | **Analytics**                                | No way to measure: signups, job posts, apply-to-accept conversion, time-to-hire, DAU. Can't tell if the product is working. Add Vercel Analytics (built-in) or PostHog.                                                           | [x]    | 106   |
...
| 14  | **Avatar storage bucket (production)**       | Upload code works against local dev Supabase Storage. Production needs configured bucket with proper RLS policies and CDN-fronted URL.                                                                                            | [x]    | 107   |
