...
- Daywork post (`POST /api/daywork`): now accepts optional `workingDayDates` string array. When provided, `workingDays` is derived from array length. Validates dates within range and no duplicates.
