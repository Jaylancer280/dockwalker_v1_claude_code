-- =============================================================================
-- Migration 00091: GDPR — soft-delete engagement_documents on DATA_SCRUBBED
--
-- Extends DATA_SCRUBBED handler to expire and soft-delete all documents
-- uploaded by the scrubbed user. The cleanup cron handles storage deletion.
-- =============================================================================
