-- =============================================================================
-- Migration 00010: Add DAYWORK.SHORTLISTED event handling
-- =============================================================================
-- Adds 'shortlisted' to the application state machine:
--   Applied -> Viewed -> Shortlisted | Accepted | Rejected | Withdrawn | Superseded
-- Shortlisted applications can be accepted or rejected by the employer.
-- =============================================================================

-- Update apply_projection to handle DAYWORK.SHORTLISTED
