-- =============================================================================
-- Migration 00094: Fix deactivation hat constraint violation
--
-- PERSON.DEACTIVATED handler was setting current_hat='deactivated', but the
-- persons table CHECK constraint only allows 'crew'|'employer'|'agent'.
-- Fix: set deactivated_at=now() instead (deactivated_at IS NOT NULL is the
-- canonical deactivation signal, checked by requireDomainUser and RLS).
-- =============================================================================
