-- =============================================================================
-- Migration 00034: Vessel Soft Data Separation + Templates Cleanup
--
-- 1. DROP vessel_operation from vessels (soft data belongs on crew_experiences)
-- 2. Update apply_projection: remove vessel_operation from VESSEL.CREATED/UPDATED
-- 3. Update get_vessel_public: remove vessel_operation from return
-- 4. DROP vessel_id from daywork_templates (vessel selection is per-posting)
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. Drop vessel_operation from vessels
-- -----------------------------------------------------------------------------
alter table public.vessels drop column if exists vessel_operation;

-- -----------------------------------------------------------------------------
-- 2. Drop vessel_id from daywork_templates
-- -----------------------------------------------------------------------------
alter table public.daywork_templates drop column if exists vessel_id;

-- -----------------------------------------------------------------------------
-- 3. Update get_vessel_public — remove vessel_operation
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 4. Update apply_projection — remove vessel_operation from VESSEL handlers
-- -----------------------------------------------------------------------------
