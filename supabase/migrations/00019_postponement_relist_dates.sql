-- Migration 00019: Postponement relist with dates
-- Updates DAYWORK.RELISTED handler in apply_projection to optionally set new dates
-- when the relist carries updated start_date/end_date/working_days.
