-- =============================================================================
-- Migration 00048: Projection State Guards
--
-- 1. Add WHERE status guards to DAYWORK.ACCEPTED and DAYWORK.REJECTED handlers
--    in apply_projection (match API-layer validation)
-- 2. Move DAYWORK.EXTENDED handler into apply_projection (consolidate)
-- 3. Drop standalone apply_daywork_extended trigger + function
-- =============================================================================

-- ---------------------------------------------------------------------------
-- 1. Replace apply_projection with state guards + EXTENDED handler
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2. Drop standalone DAYWORK.EXTENDED trigger and function (now in apply_projection)
-- ---------------------------------------------------------------------------
