-- =============================================================================
-- Migration 00080: Add smoker and visible_tattoos to profiles
--
-- Two nullable boolean fields. Collected during onboarding (crew only),
-- editable on profile page, visible to employers via view-only profile API.
-- NULL means "not set" — distinct from false.
-- =============================================================================

-- 1. Add columns
alter table public.profiles
  add column smoker boolean default null,
  add column visible_tattoos boolean default null;

-- 2. Update apply_projection — PROFILE.CREATED and PROFILE.UPDATED handlers
