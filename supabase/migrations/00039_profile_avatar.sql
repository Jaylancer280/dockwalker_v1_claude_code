...
-- ---------------------------------------------------------------------------
-- 2. Update apply_projection — add avatar_url to PROFILE handlers
-- ---------------------------------------------------------------------------
...
-- Policy: public read access (avatars are not sensitive)
