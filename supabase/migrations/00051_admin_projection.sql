-- =============================================================================
-- Migration 00051: Admin projection handler
--
-- Adds ADMIN.ENGAGEMENT_COMPLETED handler to apply_projection.
-- Same logic as DAYWORK.COMPLETED but reads daywork_id from payload.
-- =============================================================================

-- Full CREATE OR REPLACE — includes all existing handlers from 00048 unchanged,
-- plus the new ADMIN.ENGAGEMENT_COMPLETED handler.
