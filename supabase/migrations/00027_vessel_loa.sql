-- =============================================================================
-- Migration 00027: Add LOA (Length Overall) to vessels
-- Exact vessel length stored in meters. Size band auto-derived from LOA.
-- =============================================================================

-- Add loa_meters column (nullable for existing vessels until backfilled)
alter table public.vessels add column loa_meters numeric;

-- Update get_vessel_public to include loa_meters
...
-- Update apply_projection to handle loa_meters in VESSEL.CREATED and VESSEL.UPDATED
