-- =============================================================================
-- Migration 00032: NDA Reveal-After-Acceptance
--
-- 1. Update get_vessel_public to reveal IMO when caller has an active engagement
--    on a daywork linked to this vessel
-- 2. No projection changes needed — NDA immutability enforced at API layer
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. Update get_vessel_public — reveal IMO to engaged crew
-- -----------------------------------------------------------------------------
