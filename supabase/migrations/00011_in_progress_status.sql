-- =============================================================================
-- Migration 00011: Add 'in_progress' daywork status
-- =============================================================================
-- When an applicant is accepted, the daywork posting moves from 'active' to
-- 'in_progress'. This hides it from discovery and blocks new applications,
-- while still allowing the employer to complete or cancel it.
-- =============================================================================

-- Expand the status CHECK constraint on dayworks
alter table public.dayworks drop constraint dayworks_status_check;
alter table public.dayworks add constraint dayworks_status_check
  check (status in ('active', 'in_progress', 'cancelled', 'completed'));

-- Update apply_projection to set daywork to in_progress on acceptance
