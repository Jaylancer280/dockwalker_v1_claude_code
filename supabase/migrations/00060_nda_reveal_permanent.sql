-- =============================================================================
-- Migration 00060: NDA reveal for permanent engagements
--
-- Extends get_vessel_public to reveal IMO when crew has an active permanent
-- engagement on a posting linked to the NDA vessel (alongside existing
-- daywork engagement reveal).
-- =============================================================================
