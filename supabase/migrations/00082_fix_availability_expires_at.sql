-- =============================================================================
-- Migration 00082: Fix availability expires_at regression
-- 
-- Migration 00073 correctly changed AVAILABILITY.SET normal path to compute
-- expires_at server-side as d::date + interval '1 day'. Later migrations
-- (00075, 00077, 00080, 00081) that replaced apply_projection regressed the
-- handler back to (p_payload->>'expires_at')::timestamptz. The API route does
