-- =============================================================================
-- Migration 00088: GDPR — delete notification_channels on DATA_SCRUBBED
--
-- Adds DELETE FROM notification_channels and agent_placement_cities to the
-- PERSON.DATA_SCRUBBED handler in apply_projection. Hard-deletes encrypted
-- phone numbers and placement data when a user's data is scrubbed.
-- =============================================================================
