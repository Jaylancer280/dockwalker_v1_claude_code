-- =============================================================================
-- Migration 00015: Fix hat switch and agent profile projection
-- =============================================================================
-- Two bugs in 00014's apply_projection:
--   1. PERSON.HAT_CHANGED reads p_payload->>'new_hat' but the API sends
--      'current_hat'. Hat switches returned 200 but never updated persons row.
--   2. PROFILE.UPDATED dropped agency_name and role_specialization_ids columns
--      that were present in 00007. Agent profile edits silently failed to persist.
-- =============================================================================
...
begin
  case p_event_type
    ...
    when 'PERSON.HAT_CHANGED' then
      ...
      set current_hat = p_payload->>'current_hat'  -- was 'new_hat' in 00014 (bug)
