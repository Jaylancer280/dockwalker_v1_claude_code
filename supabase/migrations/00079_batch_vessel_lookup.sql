-- Batch vessel lookup: replaces N individual get_vessel_public calls with a single query
-- Same NDA logic as get_vessel_public but operates on an array of vessel IDs
