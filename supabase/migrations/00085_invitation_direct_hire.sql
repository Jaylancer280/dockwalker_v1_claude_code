-- =============================================================================
-- Migration 00085: Invitation = direct hire
--
-- 1. Make application_id nullable on active_engagements (invitation-based
--    engagements have no application row)
-- 2. Update DAYWORK.INVITATION_ACCEPTED handler to create engagement directly
--    (same logic as DAYWORK.ACCEPTED: fill position, supersede overlapping
--    applications, transition to in_progress if full)
-- =============================================================================

-- 1. Make application_id nullable
ALTER TABLE public.active_engagements ALTER COLUMN application_id DROP NOT NULL;

-- 2. Replace apply_projection with updated INVITATION_ACCEPTED handler
