-- =============================================================================
-- Migration 00012: Crew completion confirmation
-- =============================================================================
-- After an employer marks a daywork as completed, the crew member can confirm
-- or dispute the completion. Both events are recorded in the ledger.
-- The daywork remains completed regardless of crew's response.
-- =============================================================================

-- Add crew_completion_status to active_engagements
alter table public.active_engagements
  add column crew_completion_status text
  check (crew_completion_status in ('confirmed', 'disputed'));

-- Update apply_projection to handle new events
