-- =============================================================================
-- Migration 00053: Accept race guard
--
-- Adds a positions-full pre-check to the DAYWORK.ACCEPTED handler to prevent
-- race conditions where two concurrent accepts could overfill positions.
-- The guard checks positions_filled >= positions_available BEFORE processing
-- the accept, and returns early if the daywork is already full.
--
-- Only the DAYWORK.ACCEPTED handler is changed. All other handlers are
-- identical to migration 00051.
-- =============================================================================
