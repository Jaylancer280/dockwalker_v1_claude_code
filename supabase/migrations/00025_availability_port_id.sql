-- Migration 00025: Add optional port_id to availability_windows
-- Allows crew to optionally specify a port/marina alongside their city.
-- Updates apply_projection AVAILABILITY.SET handler to write port_id.

-- ---------------------------------------------------------------------------
-- 1. Add port_id column
-- ---------------------------------------------------------------------------
alter table public.availability_windows
  add column port_id uuid references public.ports(id);

create index idx_availability_port on public.availability_windows (port_id);

-- ---------------------------------------------------------------------------
-- 2. Update apply_projection to write port_id in AVAILABILITY.SET handler
-- ---------------------------------------------------------------------------
