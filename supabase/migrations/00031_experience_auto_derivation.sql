-- =============================================================================
-- Migration 00031: Experience auto-derivation
--
-- 1. Create derive_experience_profile() helper function
-- 2. Update apply_projection to call it after EXPERIENCE.ADDED/UPDATED/REMOVED
-- =============================================================================

-- -----------------------------------------------------------------------------
-- 1. derive_experience_profile: auto-derive experience_bracket_id and
--    vessel_size_exposure_ids from crew_experiences
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- 2. Update apply_projection to call derive_experience_profile after experience events
-- -----------------------------------------------------------------------------
