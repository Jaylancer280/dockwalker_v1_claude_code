-- =============================================================================
-- Migration 00092: Fix availability full-replace
--
-- AVAILABILITY.SET else branch previously only expired not_available=true rows.
-- Now expires ALL non-expired windows before inserting the new range, making
-- every SET a full replacement. Fixes stale date windows persisting after
