-- =============================================================================
-- Rollback 00041: Permanent Opportunity Signal
--
-- 1. Drop permanent_opportunity_accuracy from engagement_ratings
-- 2. Drop permanent_opportunity from daywork_templates
-- 3. Drop permanent_opportunity from dayworks
-- 4. Restore apply_projection from migration 00039 (with avatar_url, without permanent_opportunity)
-- =============================================================================
...
alter table public.engagement_ratings
  drop column if exists permanent_opportunity_accuracy;

-- ---------------------------------------------------------------------------
-- 2. Drop permanent_opportunity from daywork_templates
-- ---------------------------------------------------------------------------
alter table public.daywork_templates
  drop column if exists permanent_opportunity;
...
-- ---------------------------------------------------------------------------
-- 4. Restore apply_projection from migration 00039 (without permanent_opportunity)
-- ---------------------------------------------------------------------------
