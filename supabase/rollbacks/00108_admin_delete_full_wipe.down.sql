-- =============================================================================
-- Rollback 00108: restore 00106 apply_projection + 00105 custom_access_token_hook
--
-- Self-contained per CLAUDE.md rule 4: restores the full previous body of both
-- replaced functions. No table changes to undo (00108 only replaces function
-- bodies), and no data changes can be reverted (the expanded scrub has already
-- destroyed the data by the time this rollback would run).
-- =============================================================================

-- 1. Restore apply_projection to its 00106 body (less-aggressive PERSON.DATA_SCRUBBED).
...
-- 2. Restore custom_access_token_hook to its 00105 body (profile-exists only).
