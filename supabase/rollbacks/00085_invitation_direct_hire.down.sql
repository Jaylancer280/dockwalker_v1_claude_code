-- =============================================================================
-- Rollback 00085: Restore previous INVITATION_ACCEPTED handler + NOT NULL
-- =============================================================================

-- Delete invitation-based engagements (NULL application_id) before re-adding NOT NULL
DELETE FROM public.active_engagements WHERE application_id IS NULL;

-- Restore NOT NULL on application_id
ALTER TABLE public.active_engagements ALTER COLUMN application_id SET NOT NULL;

-- Restore apply_projection from 00082 (with simple invitation handler)
