-- =============================================================================
-- Rollback 00038: Multi-Crew Positions
--
-- 1. Drop positions_available and positions_filled from dayworks
-- 2. Drop positions_available from daywork_templates
-- 3. Restore apply_projection from migration 00034
-- =============================================================================

-- ---------------------------------------------------------------------------
-- 1. Drop columns from dayworks
-- ---------------------------------------------------------------------------
alter table public.dayworks drop column if exists positions_filled;
alter table public.dayworks drop column if exists positions_available;

-- ---------------------------------------------------------------------------
-- 2. Drop column from daywork_templates
-- ---------------------------------------------------------------------------
alter table public.daywork_templates drop column if exists positions_available;
