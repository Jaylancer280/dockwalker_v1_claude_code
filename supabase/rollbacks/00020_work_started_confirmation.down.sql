-- Rollback 00020: Remove work started confirmation columns and revert apply_projection to 00019 state

-- Drop columns
alter table public.active_engagements
  drop column if exists work_started_status,
  drop column if exists work_started_at;

-- Restore apply_projection from 00019 (without ENGAGEMENT.WORK_STARTED handlers)
