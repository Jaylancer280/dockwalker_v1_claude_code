-- Rollback 00027: Remove loa_meters from vessels
-- Restore apply_projection and get_vessel_public to migration 00025 version

alter table public.vessels drop column if exists loa_meters;

-- Restore get_vessel_public without loa_meters
...
-- Restore apply_projection from migration 00025 (without loa_meters)
