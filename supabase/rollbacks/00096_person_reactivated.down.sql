-- Rollback 00096: restore apply_projection without PERSON.REACTIVATED handler.
-- Full function body matches migration 00094 (the previous apply_projection state).
