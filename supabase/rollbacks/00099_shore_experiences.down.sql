-- =============================================================================
-- Rollback 00099: Remove shore-based experience tables and restore 00098 state
-- =============================================================================

-- 1. Drop shore experience tables (shore_experiences first due to FK)
drop table if exists public.shore_experiences;
drop table if exists public.shore_experience_categories;

-- 2. Restore aggregate_type CHECK without 'shore_experience'
...
-- 3. Restore admin_delete_person from 00095 (without shore_experiences)
...
-- 4. Restore apply_projection from 00098 (65 handlers, no shore experience)
