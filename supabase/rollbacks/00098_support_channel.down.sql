...
-- 3. Clean up support events before reverting CHECK
delete from public.events where aggregate_type = 'support';

-- 4. Revert aggregate_type CHECK (remove 'support')
...
-- 5. Restore apply_projection from 00097 (63 handlers, self-contained)
