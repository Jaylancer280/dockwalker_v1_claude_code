-- Rollback 00081: Drop docky_interactions table and restore apply_projection from 00080
-- (which did NOT have DATA_SCRUBBED handler — that was the pre-existing gap fixed by 00081)

drop table if exists public.docky_interactions;

-- Restore apply_projection from migration 00080 (full self-contained body)
