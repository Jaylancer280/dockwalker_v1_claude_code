-- Rollback for 00128_references_pending_vessel_relaxation.sql
--
-- Audit P0-1 fix (2026-04-30): restores apply_projection to its 00126
-- form, re-imposing the source='curated' gate on REFERENCE.REQUESTED
-- (00128's only forward change was dropping that gate from the
-- apply_projection body).
