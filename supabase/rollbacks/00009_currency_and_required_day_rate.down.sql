-- Drop currency columns and revert day_rate to nullable
alter table public.daywork_templates drop column currency;

alter table public.dayworks drop column currency;

alter table public.dayworks
  alter column day_rate drop not null,
  alter column day_rate drop default;

-- Restore previous apply_projection from 00007
