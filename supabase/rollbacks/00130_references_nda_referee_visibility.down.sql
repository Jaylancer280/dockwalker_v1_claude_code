-- Rollback for 00130_references_nda_referee_visibility.sql
--
-- Audit P0-1 fix (2026-04-30): restores apply_projection to its 00129
-- form — re-imposes the NDA write-time gate on REFERENCE.REQUESTED.
