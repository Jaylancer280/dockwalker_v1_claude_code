-- =============================================================================
-- Rollback 00011: Remove 'in_progress' daywork status
-- =============================================================================
-- Reverts in_progress postings back to active, restores CHECK constraint,
-- and restores apply_projection from migration 00010.
-- =============================================================================

-- Revert any in_progress dayworks back to active
...
-- Restore apply_projection from migration 00010 (without in_progress)
