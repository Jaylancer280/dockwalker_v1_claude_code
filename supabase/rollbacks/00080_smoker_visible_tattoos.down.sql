-- Rollback 00080: remove smoker and visible_tattoos columns from profiles
-- Restore apply_projection to its 00077 state (full self-contained body)

alter table public.profiles
  drop column if exists smoker,
  drop column if exists visible_tattoos;

-- Restore apply_projection from 00077 (full self-contained body)
