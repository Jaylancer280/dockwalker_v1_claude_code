-- Rollback for 00129_references_currently_onboard.sql
--
-- Audit P0-1 fix (2026-04-30): restores apply_projection to its 00128
-- form — re-imposes the B-2 is_current=true gate on REFERENCE.REQUESTED
-- and the strict 4-field edit-lock (vessel/role/start/end all
-- unconditionally locked) on EXPERIENCE.UPDATED. Note: any references
-- whose snapshot_end_date was auto-updated by 00129 will retain those
-- values — the rollback does not undo data changes.
