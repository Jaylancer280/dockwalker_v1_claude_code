-- Rollback 00031: Remove derive_experience_profile and revert apply_projection to v30

-- Drop the helper function
drop function if exists public.derive_experience_profile(uuid);

-- Revert apply_projection to v30 state (without derive_experience_profile calls)
-- This is the full apply_projection from migration 00030
