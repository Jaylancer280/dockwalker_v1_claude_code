-- Rollback: restore apply_projection to the 00059 version (without consolidated columns)
-- and recreate the 6 supplementary triggers.
...
-- Recreate supplementary trigger: sea_time (from 00063)
...
-- Recreate supplementary trigger: desired_role (from 00064)
...
-- Recreate supplementary trigger: deck_name (from 00065)
...
-- Recreate supplementary trigger: career_status (from 00067)
...
-- Recreate supplementary trigger: location_city (from 00068)
...
-- Recreate supplementary trigger: required_languages (from 00069)
