-- =============================================================================
-- Rollback 00015: Revert hat switch and agent profile projection fixes
-- =============================================================================
-- Restores the 00014 version of apply_projection which had:
--   1. PERSON.HAT_CHANGED reading 'new_hat' (bug)
--   2. PROFILE.UPDATED missing agency_name and role_specialization_ids (bug)
-- =============================================================================
