-- =============================================================================
-- Rollback 00048: Restore apply_projection to 00041 version + recreate DAYWORK.EXTENDED trigger
-- =============================================================================

-- ---------------------------------------------------------------------------
-- 1. Restore apply_projection from 00041 (without state guards, without EXTENDED)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 2. Recreate standalone DAYWORK.EXTENDED trigger and function (from 00036)
-- ---------------------------------------------------------------------------
