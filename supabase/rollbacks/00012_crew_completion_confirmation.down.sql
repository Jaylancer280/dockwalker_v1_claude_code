-- =============================================================================
-- Rollback 00012: Remove crew completion confirmation
-- =============================================================================

-- Drop the new column
alter table public.active_engagements drop column crew_completion_status;

-- Restore apply_projection from migration 00011 (without completion confirmation events)
