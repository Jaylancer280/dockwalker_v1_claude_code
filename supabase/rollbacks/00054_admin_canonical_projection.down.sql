-- =============================================================================
-- Rollback 00054: Remove admin canonical projection handlers
--
-- Restores apply_projection to the 00053 version (with accept race guard but
-- without ADMIN.CANONICAL_ADDED / ADMIN.CANONICAL_UPDATED handlers).
-- =============================================================================
