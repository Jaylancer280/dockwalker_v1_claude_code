...
-- Restores vessel_operation column on vessels, vessel_id on daywork_templates,
-- get_vessel_public with vessel_operation, and apply_projection with vessel_operation handlers.
...
-- 4. Restore apply_projection with vessel_operation in VESSEL handlers (pre-00034 state from migration 00031)
