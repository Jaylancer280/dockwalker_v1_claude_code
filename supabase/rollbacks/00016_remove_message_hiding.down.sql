-- =============================================================================
-- Rollback 00016: Restore message hiding functionality
-- =============================================================================

-- 1. Restore hidden_by column
alter table public.messages add column if not exists hidden_by uuid[] default '{}';

-- 2. Restore RLS policy with hidden_by filter
...
-- 3. Restore apply_projection with MESSAGE.HIDDEN handler (from migration 00015)
