-- Rollback for 00123_apply_projection_null_safety.sql
--
-- Audit P0-1 fix (2026-04-30): restores apply_projection to its 00121
-- form (no null-safety guards on DAYWORK.ACCEPTED /
-- DAYWORK.INVITATION_ACCEPTED / DAYWORK.POSITIONS_UPDATED). The guards
-- added in 00123 are defensive only — un-applying them does not
-- corrupt data.
