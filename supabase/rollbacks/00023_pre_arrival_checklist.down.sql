-- Rollback 00023: Pre-arrival checklist
-- Drops engagement_checklists table and restores aggregate_type CHECK.
-- Restores apply_projection to 00022 state.

-- 1. Drop checklist table and policies
...
-- 3. Restore apply_projection to 00022 state
