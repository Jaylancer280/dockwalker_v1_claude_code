-- =============================================================================
-- Rollback 00010: Remove DAYWORK.SHORTLISTED handling
-- =============================================================================
-- Reverts apply_projection to the version from migration 00009 (without shortlist).
-- Any applications in 'shortlisted' status are reverted to 'viewed'.
-- =============================================================================

-- Revert any shortlisted applications back to viewed
update public.applications
set status = 'viewed', updated_at = now()
where status = 'shortlisted';

-- Restore apply_projection from migration 00009 (without DAYWORK.SHORTLISTED)
